...
void printPoint(const prishchepa::point_t & point)
{
  std::cout << "(" << point.x << "; " << point.y << ")";
}

void printFrameRectangle(const prishchepa::rectangle_t & rect)
{
...
int main()
{
  prishchepa::Circle circle({10.0, 10.0}, 5.5);
  prishchepa::Rectangle rectangle({55.5, 55.5}, 10.0, 20.0);
  ...
  prishchepa::Shape * shapes[] = {&circle, &rectangle};
  ...
  for (int i = 0; i < 2; i++)
  {
    ...
    std::cout << "\n";
    prishchepa::point_t newPosition{2.1 * (i + 1), 2.0 * (2 - i)};
